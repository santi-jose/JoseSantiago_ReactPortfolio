          ...
          <div className="clientWork">
            ...
            <div className="clientCards">
              <div className="clientCard">
                <h3>Client Focus</h3>
                <p>My focus is to maintain open and honest communication with my clients.</p>
              </div>
              <div className="clientCard">
                <h3>Value Proposition</h3>
                <p>I am a multi-disciplinary developer who has potential for growth. I will adapt and learn what I need to to get the job done. </p>
              </div>
              <div className="clientCard">
                <h3>Commitment to Quality</h3>
                <p>I'm a detail oriented worker who knows every detail matters. In embedded systems every bit matters, in pixel art every pixel matters. I appreciate the tedious work and look forward to putting the pieces together to make something great. </p>
              </div>
              <div className="clientCard">
                <h3>Client Centric Approach</h3>
                <p>As a developer I put my clients needs first. I strive to exceed their expectations in every way.</p>
              </div>
            </div>
          </div>
